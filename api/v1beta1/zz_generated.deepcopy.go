...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BarbicanExtraVolMounts) DeepCopyInto(out *BarbicanExtraVolMounts) {
	*out = *in
	if in.VolMounts != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BarbicanExtraVolMounts.
func (in *BarbicanExtraVolMounts) DeepCopy() *BarbicanExtraVolMounts {
	if in == nil {
		return nil
	}
	out := new(BarbicanExtraVolMounts)
	in.DeepCopyInto(out)
	return out
}
...
func (in *BarbicanTemplate) DeepCopyInto(out *BarbicanTemplate) {
	*out = *in
	...
	if in.ExtraMounts != nil {
		...
		*out = make([]BarbicanExtraVolMounts, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
