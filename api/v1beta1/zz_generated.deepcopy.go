...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BarbicanLunaTemplate) DeepCopyInto(out *BarbicanLunaTemplate) {
	*out = *in
	if in.LunaHSMCertificates != nil {
		in, out := &in.LunaHSMCertificates, &out.LunaHSMCertificates
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BarbicanLunaTemplate.
func (in *BarbicanLunaTemplate) DeepCopy() *BarbicanLunaTemplate {
	if in == nil {
		return nil
	}
	out := new(BarbicanLunaTemplate)
	in.DeepCopyInto(out)
	return out
}
