...
func (in *BarbicanAPISpec) DeepCopyInto(out *BarbicanAPISpec) {
	*out = *in
	...
	in.BarbicanTrustwayTemplate.DeepCopyInto(&out.BarbicanTrustwayTemplate)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BarbicanHSMTemplate) DeepCopyInto(out *BarbicanHSMTemplate) {
	*out = *in
	if in.IPAddress != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BarbicanHSMTemplate.
func (in *BarbicanHSMTemplate) DeepCopy() *BarbicanHSMTemplate {
	if in == nil {
		return nil
	}
	out := new(BarbicanHSMTemplate)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BarbicanTrustwayTemplate) DeepCopyInto(out *BarbicanTrustwayTemplate) {
	*out = *in
	in.BarbicanHSMTemplate.DeepCopyInto(&out.BarbicanHSMTemplate)
	if in.HSMCertificates != nil {
		in, out := &in.HSMCertificates, &out.HSMCertificates
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BarbicanTrustwayTemplate.
func (in *BarbicanTrustwayTemplate) DeepCopy() *BarbicanTrustwayTemplate {
	if in == nil {
		return nil
	}
	out := new(BarbicanTrustwayTemplate)
	in.DeepCopyInto(out)
	return out
}
